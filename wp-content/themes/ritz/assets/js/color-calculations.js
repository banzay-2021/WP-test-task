 ...
 * @return {Object} - this
 */
function _ritzColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_ritzColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_ritzColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_ritzColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _ritzColor object.
 *
 * @since Twenty Twenty 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function ritzColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _ritzColor( backgroundColor, accentHue );
