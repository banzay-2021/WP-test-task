...
if ( ! class_exists( 'Ritz_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 *
	 * @since Twenty Twenty 1.0
	 */
	class Ritz_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'ritz_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'ritz_get_localized_font_family_elements',
				array(
			...
			return ritz_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
